// Importamos las constantes del archivo que se encuentra
...
// en cada una de las rutas de nuestra API en base al
    ...
    tycs: [
      {
        id: 1,
        title: "General",
        description: `Tienda Libre is a company that offers services linked mainly to electronic commerce.
    ...
    tycs: [
      {
        id: 1,
        title: "Geral",
        description: `A Tienda Libre é uma empresa que oferece serviços ligados principalmente ao comércio electrónico.
...
export const discounts = {
  [ES_ES]: [
    {
      id: 1,
      title: "20% Off en electrónica",
      image: "/electronics.jpg",
      description:
        "Comprando cualquier producto de electrónica tenes hasta el 20% de descuento sobre el precio final",
      expiration: "30/06/2022",
    },
    {
      id: 1,
      title: "15% Off en viajes",
      image: "/travel.jpg",
      description:
        "Ahorra un 15% en cualquier destino nacional o internacional comprando el paquete completo",
  ...
  [EN_US]: [
    {
      ...
      image: "/electronics.jpg",
      description: "Up to 20% off when buying any electronic product",
      expiration: "06/30/2022",
    },
    {
      id: 1,
      title: "15% Off on travelling",
      image: "/travel.jpg",
      description:
        "Save 15% in any national or international destination by buying the complete package",
      expiration: "08/31/2022",
    },
    {
      id: 1,
      title: "35% Off in Home",
      image: "/home_electronics.jpg",
      description: "Buy any product and get 35% discount on the final price",
      expiration: "06/30/2022",
    },
  ],
  [PT_BR]: [
    {
      id: 1,
      title: "20% de desconto em eletrônicos",
      image: "/electronics.jpg",
      description:
        "Até 20% de desconto na compra de qualquer produto eletrônico",
      expiration: "30/06/2022",
    },
    {
      id: 1,
      title: "15% de desconto em viagens",
      image: "/travel.jpg",
      description:
        "Economize 15% em qualquer destino nacional ou internacional comprando o pacote completo",
      expiration: "31/08/2022",
    },
    {
      id: 1,
      title: "35% de desconto em casa",
      image: "/home_electronics.jpg",
      description:
        "Compre qualquer produto e ganhe 35% de desconto no preço final",
      expiration: "30/06/2022",
    },
  ],
};
